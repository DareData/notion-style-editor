Feature: Slide show
	...
	Scenario: adds a new slide show
		...
		Then I check that editor retrieved text contains "<https://docs.google.com/presentation/d/e/2PACX-1vT0nMAZIdwHy865xDgMvB4gHezfuYURPP9naakB8VDhdRBl0S96i-ixydydXUTZ-8HjTMmxoeQ4YP_M/pub?start=false&loop=false&delayms=3000>" value
